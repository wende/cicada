...
class TestGetFileLines:
    ...
    def test_get_file_lines_file_not_found(self, tmp_path):
        ...
        mock_runner.add_git_response(
            ...
            response=MockCompletedProcess(returncode=1, stderr="fatal: path 'missing.py' does not exist")
        )
...
class TestFindMatchingLine:
    ...
    def test_find_matching_line_moved_up(self, tmp_path):
        ...
        result = mapper._find_matching_line(current_lines, "line3", 4)  # Looking for line3 at position 4
    ...
    def test_find_matching_line_moved_down(self, tmp_path):
        ...
        current_lines = ["line1", "line2", "line3", "line4"]
        result = mapper._find_matching_line(current_lines, "line2", 1)  # Looking for line2 at position 1
    ...
    def test_find_matching_line_at_boundary(self, tmp_path):
        ...
        result = mapper._find_matching_line(current_lines, "line5", 1, search_range=5)  # Within range
    ...
    def test_find_matching_line_outside_bounds(self, tmp_path):
        ...
        result = mapper._find_matching_line(current_lines, "line3", 5)  # Looking for line3 at position 5
    ...
    def test_find_matching_line_multiple_matches(self, tmp_path):
        ...
        result = mapper._find_matching_line(current_lines, "duplicate", 4)  # Looking for "duplicate" at position 4
